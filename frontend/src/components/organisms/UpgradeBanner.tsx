...
const UPSELL_BY_PLAN: Record<string, UpsellConfig> = {
  FREE: {
    targetPlan: 'PRO',
    icon: Sparkles,
    title: 'Precisa de mais cartões para os seus diferentes negocios?',
    description: 'Faça upgrade para o Pro — ate 3 cartões, analytics, galeria, agendamento e muito mais por apenas R$30/ano.',
  ...
  BUSINESS: {
    ...
    icon: Crown,
    title: 'Destaque a sua marca com domínio customizado.',
    description: 'Faça upgrade para o Enterprise — domínio proprio (suaempresa.com) por R$299,90/ano.',
