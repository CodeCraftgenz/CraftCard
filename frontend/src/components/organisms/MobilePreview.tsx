...
/** Moldura de celular para pre-visualizacao do cartao no editor */
    ...
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <div className="relative rounded-[30px] overflow-hidden bg-[#0a0a1a]" style={{ height: 'calc(70vh - 12px)' }}>
          ...
          {/* Sobreposicao de brilho (efeito vidro) */}
        ...
        {/* Brilho colorido abaixo do celular (cor de destaque) */}
        {accentColor && (
          <div
